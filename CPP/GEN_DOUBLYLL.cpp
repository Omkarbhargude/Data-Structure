...
int main()
{
    ...
    DoublyLL<string> sobj;

    sobj.InsertAtLast("ALL");
    sobj.InsertAtFirst("BLL");
    sobj.InsertAtLast("CLL");
    sobj.InsertAtFirst("DLL");
    sobj.InsertAtLast("SLL");

    sobj.DisplayGenList();

    sobj.InsertAtPosition("ALL",3);

    sobj.DisplayGenList();

    bRet = sobj.SearchAllOuccurence("ALL");
    cout<<bRet;
    return 0;
}